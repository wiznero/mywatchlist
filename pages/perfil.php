...
<main>
    <div class="cabecera-perfil">
        <img src="/mywatchlist/assets/img/img_usuario/default.jpg" alt="Foto de perfil" class="foto-perfil">
        <h1><?= $_SESSION['usuario_nombre'] ?></h1>
        <p><?php echo $perfil['bio']; ?></p>
        <p>miembro desde: <?php echo $perfil['fecha_registro']; ?></p>
    </div>
